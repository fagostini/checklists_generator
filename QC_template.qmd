...
Open the LIMS _Project summry_ page:
...
Positive and negative controls are valid for a calendar year, in their own P.Ositive and N.Egative projects. Generally, add them only if it explicitly stated in the running notes.
